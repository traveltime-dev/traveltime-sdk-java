...
public class TimeMapFastTest {
  ...
  public void shouldSendTimeMapFastRequest() {
    ...
    TimeMapFastRequest request =
        new TimeMapFastRequest(createArrivalSearches(coords, transportation));
  ...
  public void shouldSendTimeMapFastBoundingBoxRequest() {
    ...
    TimeMapFastBoxesRequest request =
        new TimeMapFastBoxesRequest(createArrivalSearches(coords, transportation));
  ...
  public void shouldSendTimeMapFastWktRequest() {
    ...
    TimeMapFastWktRequest request =
        new TimeMapFastWktRequest(createArrivalSearches(coords, transportation), true);
