...
public class JsonUtilsTest {
  ...
  public void shouldParseAllJsonFiles() throws IOException {
    List<ImmutablePair<Class<Object>, String>> jsons =
        Arrays.asList(
            // requests
            ...
            new ImmutablePair(
                SupportedLocationsRequest.class, "dto/requests/supportedLocationsRequest.json"),
            new ImmutablePair(
                TimeFilterFastRequest.class, "dto/requests/timeFilterFastRequest.json"),
            new ImmutablePair(
                TimeFilterSectorsRequest.class, "dto/requests/timeFilterSectorsRequest.json"),
            new ImmutablePair(
                TimeFilterDistrictsRequest.class, "dto/requests/timeFilterDistrictsRequest.json"),
            new ImmutablePair(
                TimeFilterPostcodesRequest.class, "dto/requests/timeFilterPostcodesRequest.json"),
            ...
            new ImmutablePair(
                TimeMapBoxesResponse.class, "dto/responses/timeMapBoxesResponse.json"),
            ...
            new ImmutablePair(
                SupportedLocationsResponse.class, "dto/responses/supportedLocationsResponse.json"),
            new ImmutablePair(
                TimeFilterFastResponse.class, "dto/responses/timeFilterFastResponse.json"),
            new ImmutablePair(
                TimeFilterDistrictsResponse.class,
                "dto/responses/timeFilterDistrictsResponse.json"),
            new ImmutablePair(
                TimeFilterSectorsResponse.class, "dto/responses/timeFilterSectorsResponse.json"),
            new ImmutablePair(
                TimeFilterPostcodesResponse.class,
                "dto/responses/timeFilterPostcodesResponse.json"),
            ...
            new ImmutablePair(
                PublicTransportPart.class, "dto/common/routes/public_transport.json"));

    for (ImmutablePair<Class<Object>, String> json : jsons) {
      String expectedContent = Common.readFile(json.getValue());
      String result =
          JsonUtils.toJsonPretty(JsonUtils.fromJson(expectedContent, json.getKey()).get()).get();
  ...
  public void shouldParseListOfProperties() throws IOException {
    ...
    String result =
        JsonUtils.toJsonPretty(
                JsonUtils.fromJson(expectedContent, new TypeReference<List<Property>>() {}).get())
            .get();
    Assert.assertEquals(expectedContent, result);
  }
}
